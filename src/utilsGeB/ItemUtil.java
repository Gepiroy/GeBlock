...
public class ItemUtil {
	...
	public static ItemStack createArmorColored(Material mat, String DisplayName, String[] lore, int r, int g, int b) {
		ItemStack item = create(mat,1,0,DisplayName,lore,null,null);
	...
	public static ItemStack createal(Material material, int amount, int data, String DisplayName, List<String> lore, Enchantment ench, int lvl) {
		ItemStack item = new ItemStack(material, amount, (short)data);
		ItemMeta meta = item.getItemMeta();
		if(DisplayName != null){
			meta.setDisplayName(DisplayName);
